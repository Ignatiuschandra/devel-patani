    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                <form class="login100-form validate-form" action="{{ url('do-register') }}" method="post">
                    @csrf
                    {{-- <span class="login100-form-title p-b-26">
                        SI BSM
                    </span> --}}
                    <center><p>Register to</p></center>
                    ...
                    <div class="wrap-input100 validate-input">
                        <input class="input100 has-val" type="text" name="nama">
                    ...
                    <div class="wrap-input100 validate-input">
                        <input class="input100 has-val" type="text" name="alamat">
                        <span class="focus-input100" data-placeholder="Alamat"></span>
                    </div>

                    <div class="wrap-input100 validate-input">
                        <input class="input100 has-val" type="text" name="nohp">
                ...
                <br>
                <p class="text-center">Already have an account? <a href="{{ url('login') }}">Login Now</a></p>
            </div>
        </div>
    </div>
